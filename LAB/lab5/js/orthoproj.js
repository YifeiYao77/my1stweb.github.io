...
function initCube() {
    ...
    // 物体位置控制按钮
    document.getElementById("objXp").onclick = function () { objX += objStep; };
    document.getElementById("objXn").onclick = function () { objX -= objStep; };
    document.getElementById("objYp").onclick = function () { objY += objStep; };
    document.getElementById("objYn").onclick = function () { objY -= objStep; };
    document.getElementById("objZp").onclick = function () { objZ += objStep; };
    document.getElementById("objZn").onclick = function () { objZ -= objStep; };
